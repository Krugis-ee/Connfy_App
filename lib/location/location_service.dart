...
class LocationService {
 ...
 /* static const NotificationDetails platformChannelSpecifics =
  ...
  /*  await flutterLocalNotificationsPlugin.show(
    ...
    Timer? periodicTimer;
    periodicTimer = Timer.periodic(Duration(minutes: 10), (Timer timer) async {
      ...
      try {
        ...
        service.invoke(
            'wifiUpdate',
            {'wifiName': wifiName, 'wifiBSSID': wifiName}
        );
...
wificheck(String? ssid) async {
 ...
 sendStatusToServer(String shop_id, dynamic status) async {
  ...
  try {
    ...
    var request = http.Request('POST', Uri.parse('https://connfy.ragutis.com/api/check_user_status'));
