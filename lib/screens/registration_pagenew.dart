...
class _RegistrationPageState extends State<RegistrationPagenew> with WidgetsBindingObserver {
  ...
  doRegistration(String mobile_device_id, String nick_name, String dob, int gender, String email, String ssid, String chat_id) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        addItemsToLocalStorage(user_id, firstnamecontroller.text);
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  MyButoon(
                                                    loading: loading,
                                                    onPressed: () {
                                                      bool? res = emailValidate(emailcontroller.text!.trim());
