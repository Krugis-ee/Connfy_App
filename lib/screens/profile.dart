...
class ProfilePage extends StatefulWidget {
  ...
  ProfilePage(this.chatRoomId, this.uid, this.username, this.routeid, this.user_id, this.imageurl, this.token);

  @override
  State<ProfilePage> createState() => _ProfilePageState(this.chatRoomId, this.uid, this.username, this.routeid, this.user_id, this.imageurl, this.token);
}

class _ProfilePageState extends State<ProfilePage> {
  var chatRoomId, uid, username, routeid, user_id, imageurl, token;
  _ProfilePageState(this.chatRoomId, this.uid, this.username, this.routeid, this.user_id, this.imageurl, this.token);
...
//  final LocalStorage storage = new LocalStorage('wifi');
  ...
  AppBar buildAppBar() {
    return AppBar(
      ...
      leading: IconButton(
        ...
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => Chat(this.chatRoomId, this.uid, this.username, this.routeid, this.user_id, this.imageurl, Constants.myName, token)));
        },
      ),
      actions: [
        IconButton(
          ...
          children: [
            Column(
              ...
              children: [
                Text(
                  'Profile',
                  style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.blue),
                ),
              ],
            ),
          ],
  ...
  Future<void> retrive() async {
    ...
    var request = http.Request('POST', Uri.parse('https://connfy.ragutis.com/api/user_profile'));
