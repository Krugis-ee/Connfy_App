...
class ChatList_backup extends StatefulWidget {
  final authcode;

  ChatList_backup(this.authcode);

  _MyAppState createState() => _MyAppState(this.authcode);
}

class _MyAppState extends State<ChatList_backup> {
  var authcode;
                  ...
                  Container(
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => ChatList_backup("1")));
                        },
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
