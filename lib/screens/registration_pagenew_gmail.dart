...
class RegistrationPagenew_gmail extends StatefulWidget {
  final User user;
  const RegistrationPagenew_gmail({Key? key, required this.user}) : super(key: key);

  @override
  State<RegistrationPagenew_gmail> createState() => _RegistrationPageState(this.user);
}
...
class _RegistrationPageState extends State<RegistrationPagenew_gmail> {
  ...
  Widget privacyPolicyLinkAndTermsOfService() {
    return Container(
      ...
      child: Center(
          child: Text.rich(TextSpan(text: 'I agreed your Terms of Service and Conditions. ', style: GoogleFonts.poppins(fontSize: 14, color: Colors.black26), children: <TextSpan>[
        TextSpan(
            text: '',
...
// Method to show error messages
  ...
  validateData() {
    print(nameflag.toString() + "dfhh" + dobflag.toString() + "dfhh" + emailflag.toString() + "dfhh" + gender_flg.toString() + "dfhh" + rememberMe.toString());
    if (nameflag == false && dobflag == false && emailflag == false && gender_flg == false && rememberMe == true) {
      _checkAndRequestPermissions();
